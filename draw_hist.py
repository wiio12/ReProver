...
miniF2F_POETRY, miniF2F_POETRY_length = collect_proofs("miniF2F_POETRY_all.log")
miniF2F_GPTF, miniF2F_GPTF_length = collect_proofs("miniF2F_GPTF_all.log")
...
plt.xticks(np.arange(1, 19, 2), fontsize=14)
plt.yticks(fontsize=14)
plt.title("Proof length histogram on miniF2F", fontsize=20)
plt.yscale("log")
...
plot.figure.savefig("miniF2F_GPTF_and_POETRY_hist.pdf")
